...
public class AIAgent implements Agent<PentagoGameState, PentagoAction> {
    ...
    public AIAgent(int playerIndex, Algorithm<PentagoGameState, PentagoAction> algorithm, UtilityStrategy<PentagoGameState, PentagoAction> utilityStrategy) {
        this.playerIndex = playerIndex;
        this.algorithm = algorithm;
        algorithm.setUtilityStrategy(utilityStrategy);
    }

    //public void setAlgorithm(Algorithm<PentagoGameState, PentagoAction> algorithm) {this.algorithm = algorithm;}
